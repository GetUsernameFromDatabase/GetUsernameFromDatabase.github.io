      ...
      <div className='pt-16 px-12 mt-8'>
        <div>
          ...
          <p className='text-gray-700 dark:text-slate-500 leading-7 font-medium'>
            In today’s world, there is no limit to what one can learn. With the
            vast amount of information available, it is possible to find answers
            to almost any question or to draw conclusions based on the available
            data.
          </p>
          <p className='text-gray-700 dark:text-slate-500 leading-7 font-medium mt-3'>
            However, the key to success lies not only in acquiring knowledge but
            also in refining one’s thought process. The better one becomes at
            learning, the more knowledge they can amass. By focusing on
            developing our ability to learn, we can unlock our full potential
